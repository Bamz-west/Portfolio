    ...
    return(
        <div className="custom-2">
            ...
            <Content>
                ...
                <p>Currently I improve my skills by watching tutorials on YouTube and using resources like <a href="https://freecodecamp.org">freecodecamp</a> to further improve my knowledge and skills</p>
            </Content>
        </div>
    );
